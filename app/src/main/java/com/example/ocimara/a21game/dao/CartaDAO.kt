package com.example.ocimara.a21game.dao

/**
 * Created by Kleber on 05/02/2018.
 */
...
class CartaDAO {
    private val cartas = listOf(
            ...
            Carta(R.drawable.valete_de_espada, 11),
            Carta(R.drawable.dama_de_espada, 12),
            Carta(R.drawable.rei_de_espada, 13)
